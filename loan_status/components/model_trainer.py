...
from loan_status.utils.main_utils import load_numpy_array_data, read_yaml_file, load_object, save_object
from loan_status.entity.config_entity import ModelTrainerConfig
from loan_status.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ClassificationMetricArtifact
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        try:
            ...
            loanstatus_model = LoanStatusModel(preprocessing_object=preprocessing_obj,
                                       trained_model_object=best_model_detail.best_model)
            logging.info("Created usvisa model object with preprocessor and model")
            logging.info("Created best model file path.")
            save_object(self.model_trainer_config.trained_model_file_path, loanstatus_model)
